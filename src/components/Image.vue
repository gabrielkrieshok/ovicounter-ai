...
export default {
  ...
  methods: {
    ...
    loadDemoImage () {
      let image = new Image()
      if (this.imageType === 0) { image.src = './assets/img/type-paper.jpg' }
      if (this.imageType === 1) { image.src = '.assets/img/type-magnified.jpg' }
      if (this.imageType === 2) { image.src = '.assets/img/type-microscope.jpg' }
